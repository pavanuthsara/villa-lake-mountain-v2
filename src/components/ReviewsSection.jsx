...
const ReviewsSection = () => {
    const reviews = [
        ...
        {
            id: 2,
            name: "Happy in Portugal",
            rating: 5,
            timeAgo: "2 years ago",
            text: "Very beautiful modern villa located in front of Borala lake just 7 min drive from Weligama center and 10 min drive from Midigama by scooter. High ceilings, high quality furniture, well equipped kitchen, spacious rooms and very friendly and welcoming host. The view from the balcony is amazing. Highly recommend!",
        },
        {
            id: 3,
            name: "Jamie D",
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    <div className="mt-8 inline-flex items-center gap-3 bg-white rounded-full px-6 py-3 shadow-sm border border-gray-100">
                        ...
                        <span className="text-gray-500 text-sm">from 23 reviews</span>
                    </div>
                </div>
                ...
                <div className="text-center mt-8">
                    <a
                        href="https://www.google.com/maps/place/Villa+Lake+Mountain/"
                        target="_blank"
